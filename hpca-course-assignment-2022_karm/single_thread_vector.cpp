  ...
  for(int rowA = 0; rowA < N; rowA +=2) {
    ...
    //   for(int iter=0; iter<N; iter++){
        ...
        //   {
            ...
            ma1 = _mm256_loadu_si256((__m256i *)(matA + (rowA*N) + iter));
            mb1 = _mm256_loadu_si256((__m256i *)(matB + (colB*N) + iter));
            ma2 = _mm256_loadu_si256((__m256i *)(matA + ((rowA+1)*N) + iter));
            mb2 = _mm256_loadu_si256((__m256i *)(matB + ((colB+1)*N) + iter));
